...
import project2logo from '@/assets/images/projectsLogos/session-native.png'
import project3logo from '@/assets/images/projectsLogos/samara-lgbt.png'
import project4logo from '@/assets/images/projectsLogos/solovyev-vs-hitler.png'
